# AGENTseo Community — Session Handoff

Date: 2026-07-16  
Workspace: `/Users/maxjafarov/Desktop/golem/agentseo-main`  
...
Work only on **AGENTseo Community Edition**. Do not continue private
...
- `TRADEMARKS.md` — AGENTseo and GolemWorkers brand restrictions;
...
prevents forks from presenting themselves as official AGENTseo.
...
plugins/codex/agentseo    Codex plugin and marketer skill
...
- secret-screened `.agentseo` export/import;
...
were independently implemented against AGENTseo contracts.
...
Community status from parent: ?? agentseo-main/
```

`agentseo-main` is not currently a standalone Git repository. No files were
...
- make `agentseo-main` a standalone repository;
...
- create or approve the `@agentseo` npm organization/scope;
...
Run from `/Users/maxjafarov/Desktop/golem/agentseo-main`:
