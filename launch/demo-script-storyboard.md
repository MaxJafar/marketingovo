...
| 6–14s  | Terminal runs `npx @marketingovo/cli serve`; browser opens the local dashboard.                         | “Marketingovo is a local-first SEO operations system. Marketingovo runs on your machine with no product account.”                                                               | `Local-first · No product account · Telemetry off by default`                                                                             | Capture the actual start command and local address.                             |
...
| 71–82s | End card with install command, GitHub, and Full link.                                                   | “Marketingovo `0.11` is an alpha for design partners and contributors. Marketingovo is Apache-2.0 open source. Try it locally, or use Marketingovo for managed team workflows.” | `Apache-2.0 open source`<br>`npx @marketingovo/cli serve`<br>`github.com/MaxJafar/marketingovo`<br>`github.com/MaxJafar/marketingovo/seo` | Keep the alpha, license, and Community/Full distinction on screen.              |

## Clean voiceover transcript

An SEO audit can find a thousand issues and still leave one question: what should we fix first?

Marketingovo is a local-first SEO operations system. Marketingovo runs on your machine with no product account.
...
Marketingovo `0.11` is an alpha for design partners and contributors. Marketingovo is Apache-2.0 open source. Try it locally, or use Marketingovo for managed team workflows.
...
- Add the storyboard alt text to the video post: “A local Marketingovo alpha workflow moves from explicit data-source states to an evidence-backed action, a transparent priority explanation, and a verification run.”
