...
| 6–14s  | Terminal runs `npx @agentseoapp/cli serve`; browser opens the local dashboard.                          | “AGENTseo is a local-first SEO operations system. AGENTseo runs on your machine with no product account.”                                                           | `Local-first · No product account · Telemetry off by default`                                                                    | Capture the actual start command and local address.                             |
...
| 71–82s | End card with install command, GitHub, and Full link.                                                   | “AGENTseo `0.11` is an alpha for design partners and contributors. AGENTseo is Apache-2.0 open source. Try it locally, or use AGENTseo for managed team workflows.” | `Apache-2.0 open source`<br>`npx @agentseoapp/cli serve`<br>`github.com/MaxJafar/AGENTseo`<br>`github.com/MaxJafar/AGENTseo/seo` | Keep the alpha, license, and Community/Full distinction on screen.              |

## Clean voiceover transcript

An SEO audit can find a thousand issues and still leave one question: what should we fix first?

AGENTseo is a local-first SEO operations system. AGENTseo runs on your machine with no product account.
...
AGENTseo `0.11` is an alpha for design partners and contributors. AGENTseo is Apache-2.0 open source. Try it locally, or use AGENTseo for managed team workflows.
