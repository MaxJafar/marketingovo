...
| ------ | ------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| 0–6s   | Start on a dense audit export, then cut to the Golem SEO Top 5 Actions view.                            | “An SEO audit can find a thousand issues and still leave one question: what should we fix first?”                                                                                   | `From issue volume → to a defensible decision`                                                                               | The issue export must be clearly labeled illustrative.                          |
| 6–14s  | Terminal runs `npx @golem-seo/cli serve`; browser opens the local dashboard.                            | “Golem SEO is a local-first SEO operations system. Community Edition runs on your machine with no product account.”                                                                 | `Local-first · No product account · Telemetry off by default`                                                                | Capture the actual start command and local address.                             |
...
| 71–82s | End card with install command, GitHub, and Full link.                                                   | “Golem SEO `0.11` is an alpha for design partners and contributors. Community is source-available under ELv2. Try it locally, or use GolemWorkers Full for managed team workflows.” | `Source-available under ELv2`<br>`npx @golem-seo/cli serve`<br>`github.com/GolemWorkers/golem-seo`<br>`golemworkers.com/seo` | Keep the alpha, license, and Community/Full distinction on screen.              |

## Clean voiceover transcript

An SEO audit can find a thousand issues and still leave one question: what should we fix first?

Golem SEO is a local-first SEO operations system. Community Edition runs on your machine with no product account.
...
Golem SEO `0.11` is an alpha for design partners and contributors. Community is source-available under ELv2. Try it locally, or use GolemWorkers Full for managed team workflows.
...
- Add the storyboard alt text to the video post: “A local Golem SEO alpha workflow moves from explicit data-source states to an evidence-backed action, a transparent priority explanation, and a verification run.”
