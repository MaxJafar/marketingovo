...
createInterface({ input: process.stdin }).on("line", (line) => {
  ...
  if (process.env.DBUS_SESSION_BUS_ADDRESS !== "unix:path=/private/golem-seo-test-bus") {
