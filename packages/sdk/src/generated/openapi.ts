  ...
  "/api/v1/golemworkers/device/start": {
    ...
    post: {
      ...
      responses: {
        ...
        /** @description A device-link request is already active. */
        409: {
          headers: {
            [name: string]: unknown;
          };
        ...
        /** @description Too many device-link attempts were made. */
        429: {
          headers: {
            [name: string]: unknown;
          };
        ...
        /** @description GolemWorkers returned an invalid response. */
        502: {
          headers: {
            [name: string]: unknown;
          };
        ...
        /** @description GolemWorkers is unavailable. */
        503: {
          headers: {
            [name: string]: unknown;
          };
  ...
  "/api/v1/golemworkers/import": {
    ...
    post: {
      ...
      responses: {
        ...
        /** @description Golem SEO Full is required for this import. */
        402: {
          headers: {
            [name: string]: unknown;
          };
        ...
        /** @description The local project was not found. */
        404: {
          headers: {
            [name: string]: unknown;
          };
        ...
        /** @description Connect this device to GolemWorkers first. */
        409: {
          headers: {
            [name: string]: unknown;
          };
        ...
        /** @description The project bundle is too large. */
        413: {
          headers: {
            [name: string]: unknown;
          };
