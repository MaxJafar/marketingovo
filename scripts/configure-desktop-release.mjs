...
const placeholder = "__MARKETINGOVO_UPDATER_PUBLIC_KEY__";
...
if (process.platform === "win32") {
  ...
  if (!thumbprint || !/^[0-9A-F]{40}$/u.test(thumbprint)) {
    throw new Error(
      "MARKETINGOVO_WINDOWS_CERTIFICATE_THUMBPRINT must contain the imported Windows signing certificate thumbprint",
    );
  }
