...
const ledgerPath = path.join(
  repoRoot,
  "docs/intel/reverse-engineering/provenance-ledger.json",
);
const cardsPath = path.join(
  repoRoot,
  "docs/intel/reverse-engineering/behavioral-cards.md",
);
...
const sourceScanAllowlist = new Set([
  ...
  // Excludes the corpus from the deployment-stance gate, so it must name it.
  // Naming the corpus to skip it is the opposite of consuming it.
  "scripts/validate-no-containers.mjs",
]);
