...
CSV_PARSER_VERSION = "marketingovo-python-competitive-pulse-csv@1.0.0"
METRIC_CATALOG_VERSION = "competitive-pulse.v1"
CSV_CONNECTOR_VERSION = "local.competitive-pulse-import@1.0.0"
FIXTURE_INPUT_SCHEMA_ID = "marketingovo.fixture-observations.v1"
CSV_INPUT_SCHEMA_ID = "marketingovo.competitive-pulse-import.v1"
OBSERVATION_SCHEMA_ID = "marketingovo.observations.v1"
REPORT_SCHEMA_ID = "marketingovo.comparison-report.v1"
CSV_REPORT_SCHEMA_ID = "marketingovo.comparison-report.v2"
