...
CSV_PARSER_VERSION = "agentintel-python-competitive-pulse-csv@1.0.0"
METRIC_CATALOG_VERSION = "competitive-pulse.v1"
CSV_CONNECTOR_VERSION = "local.competitive-pulse-import@1.0.0"
FIXTURE_INPUT_SCHEMA_ID = "agentintel.fixture-observations.v1"
CSV_INPUT_SCHEMA_ID = "agentintel.competitive-pulse-import.v1"
OBSERVATION_SCHEMA_ID = "agentintel.observations.v1"
REPORT_SCHEMA_ID = "agentintel.comparison-report.v1"
CSV_REPORT_SCHEMA_ID = "agentintel.comparison-report.v2"
